<nav x-data="{ open: false }" id="main-navbar" style="background: rgba(24,24,40,0.96); border-radius: 0.7rem; box-shadow: 0 8px 32px #0005; padding: 0.6rem 2.2rem; margin: 1.2rem auto 2.2rem auto; max-width: 1100px; position: sticky; top: 18px; z-index: 50; transition: box-shadow .2s, background .2s;">
    <style>
        ...
        .modern-dropdown a, .modern-dropdown button, .modern-dropdown form {
            color: #fff !important;
            font-weight: 500;
        ...
        .modern-dropdown a:hover, .modern-dropdown button:hover {
  ...
  /* pointer-events: none; */
    ...
    <div class="flex justify-between h-14 items-center">
        <div class="flex items-center gap-4">
            <div class="flex items-center gap-2">
                <img src="{{ asset('assets/img/logo_futami.png') }}" alt="Futami Logo" style="height:32px; background:rgba(255,255,255,0.10); border-radius:0.7rem; padding:0.2rem 0.7rem;">
                <img src="{{ asset('assets/img/logo_limit_x.png') }}" alt="Limit X Logo" style="height:32px; background:rgba(255,255,255,0.10); border-radius:0.7rem; padding:0.2rem 0.7rem;">
            </div>
            <!-- Navigation Links -->
            <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex items-center">
                ...
                <!-- Dropdown Mikrobiologi -->
                <div x-data="{ open: false }" class="relative h-14 flex items-center">
                    <button @click="open = !open" type="button" class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-green-900 bg-yellow-300 hover:bg-green-400 focus:outline-none transition ease-in-out duration-150">
                        Mikrobiologi
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :href="route('dashboard')" :active="request()->routeIs('dashboard')" style="color: #fff; font-weight: 600;">
                {{ __('Dashboard') }}
